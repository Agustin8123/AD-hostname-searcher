...
def ejecutar_tui() -> None:
    ...
    while True:
        print("=" * ancho)
        print("DISPONIBILIDAD DE EQUIPOS EN AD - MODO INTERACTIVO".center(ancho))
        print("=" * ancho)

        usar_demo = preguntar_opcion(
            "Fuente de datos:",
            ["Datos de ejemplo (demo, no toca Active Directory)",
...
def main() -> None:
    ...
    parser.add_argument("--demo", action="store_true",
                         help="Usa datos de ejemplo en vez de consultar AD real.")
